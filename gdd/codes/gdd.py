...
for x0 in start_points:
    ...
    # We use 'abs(min_x - cp) < 1e-3' to compare if the current 'min_x' is close enough to any existing point in the list
...
# 'np.unique()' ensures that we only keep unique critical points (removes any duplicates)
